...
__NOTE:__ Since Amazon Bedrock is still private preview and not GA as of 2023-08-12, you will need to obtain the Bedrock-specific Python packages required to build this Docker image; they are not included in this repository. If you have access to Bedrock in Preview, you will also have access to the latest versions of these packages. As of 2023-08-12, the versions of those packages are: `awscli-1.29.21-py3-none-any.whl`, `boto3-1.28.21-py3-none-any.whl`, and `botocore-1.31.21-py3-none-any.whl`.
